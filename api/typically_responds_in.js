...
const grabAllLandlords = require('./postgres_api').grabAllLandlords
...
const calculateTypicalResponseTime = require('./calculation_api').calculateTypicalResponseTime
const updateTypicalResponseTime = require('./postgres_api').updateTypicalResponseTime


modules.runBatchJob = function(){
